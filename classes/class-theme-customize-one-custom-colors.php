 ...
 */
class Theme_customize_One_Custom_Colors {
	...
	public function custom_color_variables() {
		if ( 'ffffff' !== strtolower( get_theme_mod( 'background_color', 'FFFFFF' ) ) ) {
			wp_add_inline_style( 'theme-customize-one-style', $this->generate_custom_color_variables() );
		}
	}
	...
	public function editor_custom_color_variables() {
		...
		$background_color = get_theme_mod( 'background_color', 'D1E4DD' );
		if ( 'd1e4dd' !== strtolower( $background_color ) ) {
			wp_add_inline_style( 'theme-customize-one-custom-color-overrides', $this->generate_custom_color_variables( 'editor' ) );
		}
	}
