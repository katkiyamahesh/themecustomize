 ...
 */
class theme_customize_One_Customize_Color_Control extends WP_Customize_Color_Control {
	/**
	 * The control type.
	 *
	 * @since Theme Customize 1.0
	 ...
	 * @var string
	 */
	public $type = 'theme-customize-one-color';
	...
	public function enqueue() {
		...
		// Enqueue the script.
		wp_enqueue_script(
			'themecustomizeone-control-color',
